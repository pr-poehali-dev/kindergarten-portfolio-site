...
const Index = () => {
  ...
  const achievements = [
    ...
    },
    {
      icon: 'Users',
      title: 'Опыт работы',
      description: '12 лет в дошкольном образовании',
      color: 'bg-gradient-to-br from-[#FF6B9D] to-[#FFA07A]',
    },
    {
      icon: 'Star',
        ...
        <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 animate-fade-in">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Воспитатель детского сада с 12-летним опытом работы. Создаю пространство для
              развития и творчества каждого ребенка.
            </p>
          ...
          <Card className="border-[#4ECDC4]/30 shadow-lg">
            <CardContent className="p-8 md:p-12">
              <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                <p>
                  Меня зовут Мария Иванова, и я уже 12 лет работаю воспитателем в детском саду.
                  Моя главная цель — создать для каждого ребенка безопасную и развивающую среду,
                  где он может раскрыть свой потенциал.
                </p>
                <p>
                  Я верю, что дошкольное детство — это уникальный период в жизни человека, когда
                  закладываются основы личности. Поэтому в своей работе я использую
                  индивидуальный подход к каждому ребенку, учитывая его особенности и интересы.
                </p>
                <p>
                  Постоянно совершенствую свои профессиональные навыки, изучаю новые методики и
                  технологии в области дошкольного образования.
                </p>
              </div>
            </CardContent>
          </Card>
              ...
              <CardContent className="p-8">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-500">2008-2013 • Дошкольная педагогика и психология</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-8">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-500">2023 • 144 часа</p>
                  </div>
                </div>
              </CardContent>
            </Card>
      ...
      <section id="portfolio" className="py-24 px-4">
        <div className="container mx-auto">
          ...
          <p className="text-center text-xl text-gray-600 mb-12 max-w-2xl mx-auto">
            Галерея детских работ и реализованных проектов
          </p>
